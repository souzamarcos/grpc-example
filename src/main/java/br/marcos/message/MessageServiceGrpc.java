...
public final class MessageServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<br.marcos.message.MessageRequest,
      br.marcos.message.MessageResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = br.marcos.message.MessageRequest.class,
      responseType = br.marcos.message.MessageResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<br.marcos.message.MessageRequest,
      br.marcos.message.MessageResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<br.marcos.message.MessageRequest, br.marcos.message.MessageResponse> getSayHelloMethod;
    if ((getSayHelloMethod = MessageServiceGrpc.getSayHelloMethod) == null) {
      synchronized (MessageServiceGrpc.class) {
        if ((getSayHelloMethod = MessageServiceGrpc.getSayHelloMethod) == null) {
          MessageServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<br.marcos.message.MessageRequest, br.marcos.message.MessageResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  br.marcos.message.MessageRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  br.marcos.message.MessageResponse.getDefaultInstance()))
              .setSchemaDescriptor(new MessageServiceMethodDescriptorSupplier("SayHello"))
              .build();
        }
      }
    }
  ...
  public static abstract class MessageServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(br.marcos.message.MessageRequest request,
        io.grpc.stub.StreamObserver<br.marcos.message.MessageResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                br.marcos.message.MessageRequest,
                br.marcos.message.MessageResponse>(
  ...
  public static final class MessageServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MessageServiceBlockingStub> {
    ...
    /**
     */
    public br.marcos.message.MessageResponse sayHello(br.marcos.message.MessageRequest request) {
  ...
  public static final class MessageServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MessageServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<br.marcos.message.MessageResponse> sayHello(
        br.marcos.message.MessageRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((br.marcos.message.MessageRequest) request,
              (io.grpc.stub.StreamObserver<br.marcos.message.MessageResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class MessageServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return br.marcos.message.MessageProto.getDescriptor();
    }
